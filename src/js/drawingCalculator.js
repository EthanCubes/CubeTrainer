...
function fMove() {
    ...
    cubePosTemp[28] = cubePos[28];
    cubePosTemp[29] = cubePos[29];
    ...
    cubePosTemp[50] = cubePos[50];
    cubePosTemp[51] = cubePos[51];
    cubePosTemp[52] = cubePos[52];
    cubePosTemp[53] = cubePos[53];
...
function fPrime() {
    ...
    cubePosTemp[4] = cubePos[4];
    cubePosTemp[5] = cubePos[5];
    cubePosTemp[6] = cubePos[27];
    cubePosTemp[7] = cubePos[30];
    cubePosTemp[8] = cubePos[33];

    // orange
    cubePosTemp[9] = cubePos[9];
    cubePosTemp[10] = cubePos[10];
    cubePosTemp[11] = cubePos[8];
    cubePosTemp[12] = cubePos[12];
    cubePosTemp[13] = cubePos[13];
    cubePosTemp[14] = cubePos[7];
    cubePosTemp[15] = cubePos[15];
    cubePosTemp[16] = cubePos[16];
    cubePosTemp[17] = cubePos[6];

    // green
    cubePosTemp[18] = cubePos[20];
    cubePosTemp[19] = cubePos[23];
    cubePosTemp[20] = cubePos[26];
    cubePosTemp[21] = cubePos[19];
    cubePosTemp[22] = cubePos[22];
    cubePosTemp[23] = cubePos[25];
    cubePosTemp[24] = cubePos[18];
    cubePosTemp[25] = cubePos[21];
    cubePosTemp[26] = cubePos[22];

    // red
    cubePosTemp[27] = cubePos[45];
    cubePosTemp[28] = cubePos[28];
    cubePosTemp[29] = cubePos[29];
    cubePosTemp[30] = cubePos[46];
    cubePosTemp[31] = cubePos[31];
    cubePosTemp[32] = cubePos[32];
    cubePosTemp[33] = cubePos[47];
    cubePosTemp[34] = cubePos[34];
    cubePosTemp[35] = cubePos[35];
    ...
    // yellow
    cubePosTemp[45] = cubePos[11];
    cubePosTemp[46] = cubePos[14];
    cubePosTemp[47] = cubePos[17];
    cubePosTemp[48] = cubePos[48];
    cubePosTemp[49] = cubePos[49];
    cubePosTemp[50] = cubePos[50];
    cubePosTemp[51] = cubePos[51];
